...
function displayCountries(countries) {
  ...
  for (let c of countries) {
    ...
    <ul class="list-group list-group-flush">
      <li class="list-group-item">Capital : ${c.capital??"no capital"}</li>
...
function displayRegions(regions) {
  ...
  for (let reg of regions) {
    data += `
    <div>
            <button class="btn btn-outline-info" onclick="filtercountriesbyRegions('${reg}')" value="${reg}">${reg}</button>
        </div>  `
  }
...
function filtercountriesbyRegions(region) {
